  ...
  return (
    <div className='h-full-screen w-full bg-gradient-to-r from-blue-100 to-blue-300 min-h-screen flex items-center justify-center overflow-hidden'>
      <form className='m-5 w-full max-w-4xl bg-white rounded-2xl shadow-lg p-8'>
        <p className='font-bold text-3xl text-center text-blue-800 mb-6'>Add Pharmacy</p>
        <div className='bg-white p-5 rounded-xl shadow-md'>
          {/* Upload Hospital Image */}
          <div className='flex items-center gap-6 mb-6'>
            <label htmlFor='pharmacy-img' className='cursor-pointer'>
              <img className='w-28 h-28 rounded-full object-cover shadow-lg' src={assets.profile_image} alt='Upload Hospital' />
            </label>
            <input type='file' id='pharmacy-img' hidden />
            <p className='text-gray-700'>Upload Pharmacy <br /> Picture</p>
          </div>

          {/* Hospital Details */}
          <div className='flex flex-col lg:flex-row gap-8 text-gray-700'>
            <div className='w-full flex flex-col gap-4'>
              <input className='border rounded-lg px-4 py-3 shadow-sm focus:ring-2 focus:ring-blue-300' type='text' placeholder='Pharmacy Name' />
          ...
          <div className='mt-6'>
            ...
            <textarea className='w-full px-4 py-3 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-300' rows='4' placeholder='Write about the pharmacy'></textarea>
          </div>
