...
const stores = [
  ...
  { id: 13, name: "Store 13", image: "/path/to/image13.jpg", address: "Goa, India", contact: "+91 4356789012", rating: 4.2 },
  { id: 14, name: "Store 14", image: "/path/to/image14.jpg", address: "Nagpur, India", contact: "+91 5467890123", rating: 3.8 },
];

const AllMedicineStoresPage = () => {
  return (
    <div className="container mx-auto p-6 max-w-[1380px]">
      <h2 className="text-3xl font-semibold text-gray-800 mb-6 text-center">All Medicine Stores</h2>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {stores.map((store) => (
          <div key={store.id} className="bg-white shadow-lg rounded-lg p-4 hover:shadow-xl transition-all duration-300">
            {/* Store Image */}
            <div className="h-40 w-full bg-gray-100 rounded-t-lg flex items-center justify-center overflow-hidden mb-4">
              <img src={store.image} alt={store.name} className="h-full object-contain" />
            </div>
            ...
            <Link 
              ...
              className="mt-4 block text-center text-white bg-blue-600 py-2 rounded-md hover:bg-blue-700 transition-all"
            >
              Visit Store
            </Link>
          </div>
