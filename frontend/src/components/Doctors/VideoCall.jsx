...
const VideoCall = () => {
  ...
  const startCall = async () => {
    try {
      ...
      console.log("Starting video call for appointment:", userId, doctorId); // FIXED: id -> userId, doctorId
      ...
      setTimeout(() => {
        if (remoteVideoRef.current) {
          // Create a new stream instead of cloning for better compatibility
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 mb-8">
      {/* Video containers */}
